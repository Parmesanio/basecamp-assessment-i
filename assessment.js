...
var responseCreator = function(param){
  param === 'green' ? colorResponse = 'Green is okay' : param === 'red' ? colorResponse = 'I heart red' : colorResponse = 'What is your favorite color?';
